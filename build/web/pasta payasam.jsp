...
<body>
    ...
    <div id="id_immagine" align="center" style="width: 100%; height: 100%;">
        <a id="a_img_id" href="images/pasta payasam.jpg">
            <img id="img_id" src="images/pasta payasam.jpg" />
        </a>
    </div>
</div>
        </div>
    ...
    <div class="container nano_head"> <!-- main contain of car-->
        ...
        <div class="container-fluid top_bar"align="center" style="color:#ffffff" ><b>pasta payasam</b></div>      
</div>

<div class="col-sm-7" align="right">
        <h3><b>pasta payasam</b></h3>
	...
	<hr>
		...
		<h4 style="color:#F08080"><img src="images/ic_pink.png" /><b>60</b> </h4>
                <div class="col-sm-7">
