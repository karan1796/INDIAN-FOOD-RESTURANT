...
<body>
    ...
    <div id="id_immagine" align="center" style="width: 100%; height: 100%;">
        <a id="a_img_id" href="images/idily dosa 2.jpg">
            <img id="img_id" src="images/idily dosa 2.jpg" />
        </a>
    </div>
</div>
        </div>
    ...
    <div class="container nano_head"> <!-- main contain of car-->
        ...
        <div class="container-fluid top_bar"align="center" style="color:#ffffff" ><b>idily</b></div>      
</div>
