...
<body>
    ...
    <div id="id_immagine" align="center" style="width: 100%; height: 100%;">
        <a id="a_img_id" href="images/wheat dosa.jpg">
            <img id="img_id" src="images/wheat dosa.jpg" />
        </a>
    </div>
</div>
        </div>
    ...
    <div class="container nano_head"> <!-- main contain of car-->
        ...
        <div class="container-fluid top_bar"align="center" style="color:#ffffff" ><b>wheat dosai</b></div>      
</div>

<div class="col-sm-7" align="right">
        <h3><b>wheat dosai</b></h3>
