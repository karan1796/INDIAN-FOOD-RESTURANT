...
<a class="navbar-brand" href="#" style="color:#178aa5">Indian Resturant</a>
      ...
      <ul class="nav navbar-nav navbar-right">
          ...
          <!-- User Nmae -->
          <li><a href="#"><span class="glyphicon glyphicon-user"></span> <b style="color:grey">Welcome </b><b style="color:green"> <%= request.getSession().getAttribute("userdb") %></b></a></li>
            ...
            <center><div class="priceing-table w3l">
	    		<div class="price-grid" style="margin-left:50px; margin-top:40px;">
	    			<div class="price-block agile">
		    			<div class="price-gd-top pric-clr2">
		    				<h4>Your Order.</h4>
		    				<h3>Your Order id is : <b id="bid"><b></h3>
							<script>
				...
				document.getElementById("bid").innerHTML = x;
		    		    ...
		    		    <div class="price-selet pric-sclr2">
                                        <a class="btn" href="#small-dialog">Thank you for Ordering<strong> www.Indian traditional Resturant</strong></a><br><br>
                                        <a class="btn" href="home_1.jsp"><strong>Click here For Next Oder</strong></a>
		    			</div>
						</div>
                        </div>
						</div></center>
