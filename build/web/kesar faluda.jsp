...
<body>
    ...
    <div id="id_immagine" align="center" style="width: 100%; height: 100%;">
        <a id="a_img_id" href="images/kesar-pista-falooda.jpg">
            <img id="img_id" src="images/kesar-pista-falooda.jpg" />
        </a>
    </div>
</div>
        </div>
    ...
    <div class="container nano_head"> <!-- main contain of car-->
        ...
        <div class="container-fluid top_bar"align="center" style="color:#ffffff" ><b>kesar faluda</b></div>      
</div>

<div class="col-sm-7" align="right">
        <h3><b>kesar faluda</b></h3>
