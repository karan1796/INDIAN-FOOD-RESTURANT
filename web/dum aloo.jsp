...
<body>
    ...
    <div id="id_immagine" align="center" style="width: 100%; height: 100%;">
        <a id="a_img_id" href="images/dum-aloo.jpg">
            <img id="img_id" src="images/dum-aloo.jpg" />
        </a>
    </div>
</div>
        </div>
    ...
    <div class="container nano_head"> <!-- main contain of car-->
        ...
        <div class="container-fluid top_bar"align="center" style="color:#ffffff" ><b>dum aloo</b></div>      
</div>
