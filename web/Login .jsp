<%-- 
    Document   : Login Form
    Created on : Sep 16, 2017, 11:21:34 AM
    Author     : Karan Singh
--%>
...
<script>
    function al(form) {
if (form.cont.value=="karan1796@gmail.com") { 
if (form.apass.value=="1234") {              
...
<a class="navbar-brand" href="#" style="color:#5a5713">INDIAN FOOD Restaurant</a>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="logincheck.jsp">
    ...
    <div  style="background-color:#5a1320">
...
<!-- UserSignup Button -->
	<li id="hi3"><a href="signup.jsp" onclick="document.getElementById('id02').style.display='block'"><span class="glyphicon glyphicon-Signup-mark"></span>Signup</a></li>
		
        
<!--           User Logged UserName Button 
<li id="hi4"><a href="#" ><span class="glyphicon glyphicon-user"></span> karan singh</a></li>
...
<!-- UserSignup Form Started -->                    
<form class="modal-content animate" action="signup.jsp"  method="POST" onsubmit="return checkForm(this)">
    <div class="imgcontainer">
...
<img src="images/nav3.jpeg" class="img-responsive" style="width:100%"/>
