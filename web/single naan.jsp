...
<body>
    ...
    <div id="id_immagine" align="center" style="width: 100%; height: 100%;">
        <a id="a_img_id" href="images/single naan.jpg">
            <img id="img_id" src="images/single naan.jpg" />
        </a>
    </div>
</div>
        </div>
    ...
    <div class="container nano_head"> <!-- main contain of car-->
        ...
        <div class="container-fluid top_bar"align="center" style="color:#ffffff" ><b>single naan</b></div>      
</div>

<div class="col-sm-7" align="right">
        <h3><b>single naan</b></h3>
	...
	<hr>
		...
		<h4 style="color:#F08080"><img src="images/ic_pink.png" /><b>5</b> </h4>
                <div class="col-sm-7">
